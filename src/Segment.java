...
public class Segment implements Shape {
	...
	/**
	 * @return the end points of this segment in a Point
	 */
	public Point getEnd() {return new Point(x2, y2);}
	...
	/**
	 * Calculates if the user clicked within 3 pixels of us. Close enough
	 * Good to see profs use StackOverflow too
	...
	/**
	 * @return a string of just the coords seperated by spaces
	 * Useful for transmission when this segment is part of a polyline
	 */
	public String cordsString(){return x1+" "+y1+" "+x2+" "+y2;}
}
